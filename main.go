...
func main() {
	...
	fileHandler := http.FileServer(http.Dir(cacheDir))
	//http.Handle("/cloud.google.com/go/", mirrorHandler("/cloud.google.com/go/", "/github.com/googleapis/google-cloud-go/", fileHandler))
	//http.Handle("/google.golang.org/appengine/", mirrorHandler("/google.golang.org/appengine/", "/github.com/golang/appengine/", fileHandler))
	http.Handle("/golang.org/x/", mirrorHandler("/golang.org/x/", "/github.com/golang/", fileHandler))
	http.Handle("/", mainHandler(fileHandler))
